...
namespace product_Test.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var students = db.Students.Include(s => s.Gender);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,Lastname,DOB,Address,PhoneNumber,GenderId")] Student student)
        {
            if (ModelState.IsValid)
            {
